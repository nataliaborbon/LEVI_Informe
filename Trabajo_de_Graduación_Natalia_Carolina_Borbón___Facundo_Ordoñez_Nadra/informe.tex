...
Este trabajo desarrolló L.E.V.I., un dispositivo de bajo costo para el seguimiento ocular, pensado para que estudiantes con severas limitaciones motrices puedan conectarse al sistema y utilizarlo tanto para rendir evaluaciones de opción múltiple como para comunicarse con su entorno académico. El dispositivo está compuesto por dos módulos basados en microcontroladores económicos y opera de forma autónoma, generando su propia red inalámbrica sin necesidad de conexión a internet, a través de la cual los docentes administran los cuestionarios, los tutores realizan el seguimiento académico del alumno, y compañeros o familiares se comunican con él.

Su valor principal radica en ofrecer una alternativa considerablemente más económica que las soluciones comerciales existentes y, a diferencia de estas, diseñada específicamente para el entorno educativo, ampliando así la autonomía y participación de estos estudiantes en el ámbito académico.
