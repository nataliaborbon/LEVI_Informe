...
En el ámbito educativo, los estudiantes con movilidad reducida enfrentan serias dificultades tanto al momento de ser evaluados como para comunicarse con docentes, tutores y compañeros. Esta situación limita su autonomía y participación en las clases, principalmente porque las instituciones no cuentan con herramientas adaptadas a sus posibilidades físicas.

Frente a esto, la tecnología de seguimiento ocular \emph{eye-tracking} se presenta como una alternativa práctica para interactuar con una pantalla utilizando únicamente la mirada, eliminando la necesidad de recurrir al movimiento manual o a la asistencia permanente de terceros.

Sin embargo, los sistemas de seguimiento ocular comerciales presentan dos grandes inconvenientes: tienen costos económicos muy elevados y carecen de un enfoque pensado para la dinámica escolar o universitaria. En la práctica, no existen soluciones accesibles que permitan a los profesores armar y tomar exámenes y que, al mismo tiempo, le sirvan al alumno para comunicarse dentro del ámbito de estudio.
...
Todos los ejemplos de sistemas que utilizan eye-tracking expuestos anteriormente, ya sea por hardware, software o una combinación de ambos, son herramientas de enorme calidad que pueden aplicarse en una gran variedad de campos. Han aportado una amplia gama de dispositivos sumamente versátiles que ayudan tanto a investigaciones científicas y de marketing de alto nivel como también a facilitar acciones cotidianas.
...
Por todo lo anterior expuesto es que se propone este proyecto. Una solución que mantenga la ergonomía y la portabilidad de los dispositivos antes mencionados, sumando a su vez un bajo costo económico, impulsado por el uso de hardware y software de bajos recursos y una orientación exclusiva al ámbito educativo y familiar de personas con discapacidades motoras.
